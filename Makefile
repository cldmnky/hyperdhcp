...
# blahonga.me/hyperdhcp-bundle:$VERSION and blahonga.me/hyperdhcp-catalog:$VERSION.
IMAGE_TAG_BASE ?= blahonga.me/hyperdhcp
...
$(GOX): $(LOCALBIN)
	test -s $(GOX)/gox || GOBIN=$(LOCALBIN) go install github.com/mitchellh/gox@v1.0.1
